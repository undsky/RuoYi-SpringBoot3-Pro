...
public class TokenService {
    ...
    public void refreshToken(LoginUser loginUser) {
        if (!singleLogin) {
            String userIdKey = getUserKey(loginUser.getUserId());
            String oldTokenKey = redisCache.getCacheObject(userIdKey);
        ...
        String newTokenKey = getTokenKey(loginUser.getToken());
        redisCache.setCacheObject(newTokenKey, loginUser, expireTime, TimeUnit.MINUTES);

        if (!singleLogin) {
            String userIdKey = getUserKey(loginUser.getUserId());
            redisCache.setCacheObject(userIdKey, newTokenKey, expireTime, TimeUnit.MINUTES);
        }
    }
