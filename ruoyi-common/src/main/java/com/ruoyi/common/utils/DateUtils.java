...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    ...
    public static String getYYYY() {
        return getYYYY(new Date());
    }

    public static String getYYYY_MM(final Date date) {
        return parseDateToStr(YYYY_MM, date);
    }

    public static String getYYYY_MM() {
        return getYYYY_MM(new Date());
    }
    ...
    public static String getYYYY_MM_DD_HH_MM_SS(final Date date) {
        return parseDateToStr(YYYY_MM_DD_HH_MM_SS, date);
    }

    public static String getYYYY_MM_DD_HH_MM_SS() {
        return getYYYY_MM_DD_HH_MM_SS(new Date());
    }

    public static String getYYYY_MM_DD_HH_MM(final Date date) {
        return parseDateToStr(YYYY_MM_DD_HH_MM, date);
    }

    public static String getYYYY_MM_DD_HH_MM() {
        return getYYYY_MM_DD_HH_MM(new Date());
    }

    public static String getHH_MM_SS(final Date date) {
        return parseDateToStr(HH_MM_SS, date);
    }

    public static String getHH_MM_SS() {
        return getHH_MM_SS(new Date());
    }

    public static String getHH_MM(final Date date) {
        return parseDateToStr(HH_MM, date);
    }

    public static String getHH_MM() {
        return getHH_MM(new Date());
    }
    ...
    public static String getYYYYMMDDHHMMSSSSS(final Date date) {
